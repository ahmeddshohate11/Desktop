...
class SceretCodeScreen extends StatelessWidget {
  const SceretCodeScreen({Key? key}) : super(key: key);
        ...
        body: Stack(
          children: [
            ...
            Positioned(
                ...
                child: Image.asset(
                  "assets/images/undraw_Security_on_re_e491-removebg-preview 1 (1).png",
                  fit: BoxFit.fill,
